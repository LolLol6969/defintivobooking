...
export default function PlanningPage() {
  ...
  async function fetchBookings() {
    try {
      ...
      console.log("[v0] Fetching bookings from Supabase")
      ...
      if (error) {
        ...
        throw new Error(error.message || "Errore durante il caricamento delle prenotazioni")
      }

      console.log("[v0] Bookings fetched successfully:", data?.length || 0, "bookings")
      setBookings(data || [])
      setError(null)
    } catch (err: any) {
      const errorMessage = err?.message || "Errore sconosciuto"
      console.log("[v0] Booking fetch error:", errorMessage)
    ...
    <div className="min-h-screen beach-background">
      ...
      <div className="pt-24 pb-20 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          {error && (
            <div className="mb-6 p-4 bg-red-100/90 border border-red-400 text-red-700 rounded-lg max-w-2xl mx-auto">
